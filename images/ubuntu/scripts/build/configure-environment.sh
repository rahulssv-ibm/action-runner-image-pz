...
# Disable IPv6 — IBM Cloud VPC does not route IPv6 traffic.
# Without this, applications may resolve dual-stack hostnames to IPv6 addresses
# and attempt connections that go nowhere, causing intermittent timeouts.
